...
function saveToLocalStorage(event) {
    ...
    localStorage.setItem(obj.email,JSON.stringify(obj)) /* since local storage only stores the data int string format thats why we have to convert the object into string with (JSON.stringify) method */ 
